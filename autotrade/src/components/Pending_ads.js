    ...
    <div class="row">
      <div class="col-md-3 col-sm-4">
        <ul class="usernavdash">
          ...
          <li class="active"><a href="#"><i class="fa fa-desktop" aria-hidden="true"></i> My Pending Ads</a></li>
          <li><a href="#"><i class="fa fa-laptop" aria-hidden="true"></i> My Active Ads</a></li>
